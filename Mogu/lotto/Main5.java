...
//	ImageIcon icon6 = new ImageIcon("D:\\Wani\\Mogu\\lotto\\image\\nut6.png");
	...
	public Main5() {
		...
		JButton btnResult = new JButton("한번에!");
		btnResult.setBackground(Color.white);
		btnResult.setBounds(50, 210, 90, 30);
		btnResult.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (count == 0) {
					...
					if (boxs[0].getIcon() == boxs[1].getIcon() && boxs[1].getIcon() == boxs[2].getIcon()
							&& (boxs[0].getIcon() == icon2 && boxs[1].getIcon() == icon2 && boxs[2].getIcon() == icon2)) {
						JOptionPane.showMessageDialog(Main5.this, "당첨 되셨습니다!!");

					} else if (boxs[3].getIcon() == boxs[4].getIcon() && boxs[4].getIcon() == boxs[5].getIcon()
							&& (boxs[3].getIcon() == icon2 && boxs[4].getIcon() == icon2 && boxs[5].getIcon() == icon2)) {
						JOptionPane.showMessageDialog(Main5.this, "당첨 되셨습니다!!");
					} else {
...
//		});
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (boxs[0].isSelected() && boxs[1].isSelected() && boxs[2].isSelected() && boxs[3].isSelected()
				&& boxs[4].isSelected() && boxs[5].isSelected()) {
			if (boxs[0].getIcon() == boxs[1].getIcon() && boxs[1].getIcon() == boxs[2].getIcon()
					&& (boxs[0].getIcon() == icon2 && boxs[1].getIcon() == icon2 && boxs[2].getIcon() == icon2)) {
				JOptionPane.showMessageDialog(Main5.this, "당첨 되셨습니다!!");
